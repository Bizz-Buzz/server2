  ...
  return knex('users').del()
    .then(function () {
      return Promise.all([
        ...
        knex('users').insert({user_id: 1, email: ' ', first_name: 'blank', last_name: "user", username: ' ', password: '$2a$12$pFuS3YkOqFKGuo6JAWqj5.gMcH3lv.V211HYtg4YAOj/Hi4KBIZ26', user_bio: 'test account'}),
